# -*- coding: utf-8 -*-
"""
Created on Sat Jul  5 18:26:25 2025

@author: gh00616
"""

# funnelMethod.py – scalar funnel helper (no Filter list)
# --------------------------------------------------------
# Implements Kiessling–Leyffer funnel logic for TRF, but **does not**
# require a ConfigBlock object.  All numeric parameters are passed
# explicitly from the caller (e.g. TRF via config.<param_name>).
#
